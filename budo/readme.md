...
- `budo_sound.h` / `budo_sound.c`: PC-speaker beeps plus optional SDL-backed tone playback.
- `budo_video.h` / `budo_video.c`: Terminal pixel buffer for LOW/HIGH resolutions.
