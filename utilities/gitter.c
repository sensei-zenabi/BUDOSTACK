...
int main(void)
{
    printf(
        ...
        "\n"
        "Quick decision guide (layman-friendly)\n"
        "  \"I committed too early (not pushed)\"   -> git reset HEAD~1\n"
        "  \"I committed on wrong shared branch\"   -> git revert <commit>\n"
        "  \"I only want to unstage files\"         -> git restore --staged <file>\n"
        "  \"I lost work after reset\"              -> git reflog, then recover commit id\n"
        "  \"I must rewrite remote history\"        -> git push --force-with-lease\n"
        "\n"
        "Notes\n"
        "  - Prefer revert over reset on shared history.\n"
        "  - Prefer --force-with-lease over --force.\n"
        "  - Use git status after each risky command.\n"
